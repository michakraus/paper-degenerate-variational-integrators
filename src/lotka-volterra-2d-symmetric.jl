module LotkaVolterra2dSymmetricDVI
    ...
    const PI_SPEC = (loop    = LotkaVolterra2dSymmetric.f_loop,
                     surface = LotkaVolterra2dSymmetric.f_surface,
                     first   = LotkaVolterra2dSymmetric.poincare_invariant_1st,
                     second  = LotkaVolterra2dSymmetric.poincare_invariant_2nd)
