module MasslessChargedParticleSingularDVI
    ...
    # "Singular" (one-component, A₂ = 0) vector potential: the gauge the degenerate
    # variational integrators are formulated for. In contrast to the Lotka-Volterra gauges,
    # this problem module provides its own plot recipes.
